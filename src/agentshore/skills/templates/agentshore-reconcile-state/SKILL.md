...
allowed-tools: Read, Grep, Glob, Bash(git status:*, git worktree list:*, git worktree remove --force:*, git worktree prune:*, git worktree repair:*, git checkout:*, git merge --abort:*, git diff:*, git log:*, ps:*, lsof:*, kill:*, find:*, stat:*, jq:*, sqlite3:*, ls:*, tail:*, head:*, awk:*, xargs:*)
---
