  ...
  return upsertCardInList(
    {
      ...
      play_id: current.play_id ?? null,
      started_at: current.started_at ?? null,
      issue_number: current.issue_number ?? null,
      pr_number: current.pr_number ?? null,
      branch: current.branch ?? null,
      trigger_agent_id: current.trigger_agent_id ?? null,
      trigger_agent_type: current.trigger_agent_type ?? null,
      trigger_error_class: current.trigger_error_class ?? null,
    },
    cards,
    agentsById,
    fallbackId,
