...
- **Atomic play finalization.** The completed play row, its work-claim transition, structured artifacts, and requested external-mutation intents commit in one `BEGIN IMMEDIATE` transaction. External effects execute only after this durable boundary.
